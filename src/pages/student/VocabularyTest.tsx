                        ...
                        <FormControl>
                          ...
                          >
                            {q.options.map((option) => (
                              <FormItem 
                                key={option} 
                                className="flex items-center space-x-3 space-y-0 bg-white p-3 rounded-md border"
                              >
                                <FormControl>
          ...
          <CardContent className="py-10 px-6">
            <div className="text-center">
              ...
              <p className="text-xl mb-8">
                {score === 100 ? "Great job! You've passed this assessment." :
                 score >= 70 ? "Good job! You've passed this assessment." :
                 "You may want to review the materials and try again."}
              </p>
