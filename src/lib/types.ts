...
// NOTE: Mock objects below were used during the prototype phase.
// They are kept for Storybook / local demo purposes but should not be imported
// by runtime pages now that the API integration is live.
