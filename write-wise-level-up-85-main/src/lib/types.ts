...
export type MaterialType = 
  ...
  | 'listening_test' 
  | 'writing_challenge' 
  | 'writing_assessment'; // Added writing_assessment type
...
export interface WritingSubmission {
  ...
  feedback?: string;
  reviewed_at?: string;
  cefrLevel?: string; // Added CEFR level from assessment
  vocabularyScore?: number; // Added detailed scores
  grammarScore?: number;
...
export interface Progress {
  ...
  score_summary: {
    ...
    topic: number;
    listening?: number;
    writing?: number; // Added writing score
  };
}
...
// Updated to include writing assessment scores
